...
/*
 * Helper methods to get/set page type  enum class is defined in b_plus_tree_page.h
 *
 * [IMPLEMENTATION] Status: DONE
 * NOTE: I let the INVALID_PAGE_ID be the parent id of a root node.
 */
 ...
 * [IMPLEMENTATION] Status: DONE
 *
 * TODO(Hoo): Confirm the correctness of this definition. (Consider this when this might be a cause)
 * while debugging.
 */
auto BPlusTreePage::GetMinSize() const -> int {
  return IsLeafPage() ? (max_size_ / 2) : (max_size_ % 2 == 0 ? max_size_ / 2 : max_size_ / 2 + 1);
}
